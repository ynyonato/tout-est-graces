...
export default function HomePage() {
  ...
  const activities = [
    {
      ...
      color: "bg-sunset/5 hover:glow-sunset hover:shadow-md",
    ...
    },
    {
      ...
      color: "bg-slate-500/5 hover:glow-silver hover:shadow-md",
    ...
    },
    {
      ...
      color: "bg-forest/5 hover:glow-forest hover:shadow-md",
  ...
  return (
    <div className="relative">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[calc(100vh-80px)] flex items-center py-12 md:py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="font-inter text-base md:text-lg leading-relaxed text-slate-655 dark:text-slate-350 max-w-xl">
          ...
          >
            ...
            <div className="absolute bottom-[32%] left-[24%] md:left-[28%] glass-effect rounded-2xl p-3 md:p-4 shadow-lg z-40 flex items-center gap-3 animate-bounce" style={{ animationDuration: '4s' }}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              ...
              <p className="font-inter text-base leading-relaxed text-slate-600 dark:text-slate-350">
              ...
              <p className="font-inter text-base leading-relaxed text-slate-655 dark:text-slate-350">
              ...
              <div className="grid grid-cols-3 gap-6 mt-8 pt-6">
                <div>
                  <h3 className="font-sora text-3xl font-bold text-forest dark:text-gold">2023</h3>
                  <p className="font-poppins text-[10px] uppercase tracking-wider text-slate-400">Création</p>
                </div>
                <div>
                  <h3 className="font-sora text-3xl font-bold text-forest dark:text-gold">3</h3>
                  <p className="font-poppins text-[10px] uppercase tracking-wider text-slate-400">Pôles d&apos;activité</p>
                </div>
                <div>
                  <h3 className="font-sora text-3xl font-bold text-forest dark:text-gold">100%</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {activities.map((act) => (
              <motion.div
                ...
                className={`flex flex-col rounded-3xl p-8 transition-theme overflow-hidden ${act.color}`}
              >
                {/* Visual card header */}
                ...
                {/* Items List */}
                <ul className="flex flex-col gap-3 font-inter text-xs mb-8 flex-grow">
      ...
      <section className="py-24 bg-slate-50/50 dark:bg-charcoal/20 transition-theme">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            {/* Right Value List (Staggered modern numbers layout) */}
      ...
      <section id="contact-section" className="py-20 bg-slate-50 dark:bg-charcoal transition-theme">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            {/* Form Column */}
            <div className="lg:col-span-7 bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-md flex flex-col gap-6 transition-theme">
              <div>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <p className="font-inter text-xs">Merci de nous avoir contactés. Notre équipe vous répondra sous 24 heures.</p>
                  <button 
                ...
                <ul className="flex flex-col gap-4 font-inter text-sm">
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400">Atakpamé, Route de Nangbéto, Togo</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
